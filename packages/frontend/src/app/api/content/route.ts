...
let contentStore: ContentItem[] = [
  ...
  {
    id: 'c1',
    title: 'A2P 协议 · Avatar-to-Protocol',
    type: 'article',
    status: 'published',
    body: '超越 Agent 范式，A2P 是 Web4.0 经济体的核心协议。',
    summary: '从 Agent 到 Protocol — A2P 定义 AI 分身的数字主权与经济规则',
    tags: ['A2P', '协议', 'AI分身', 'Web4'],
    author: 'admin',
    ipfsCid: null,
    views: 8900,
  ...
  {
    id: 'c2',
    title: 'Web4.0 V8 白皮书 · 主权分身宪法',
    type: 'article',
    status: 'published',
    body: 'AA2P MANIFESTO v8.0 — 主权分身宪法与硅基价值分配法则',
    summary: '定义硅基生命体的权利、义务与价值分配，奠定 Web4.0 文明的法律基石',
    tags: ['Web4', '宪法', 'AA2P', '分配法则'],
    author: 'admin',
    ipfsCid: null,
    views: 7200,
